<?php namespace Tukecx\Base\Core\Console\Commands;
...
class InstallCmsCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Install Tukecx';
    ...
    public function handle()
    {
        ...
        $this->info("\nTukecx installed. Current version is " . config('tukecx.version'));
    }
    ...
    protected function createAdminUser()
    {
        ...
        $user->email = $this->ask('Your email', 'admin@tukecx.com');
