...
trait RepositoryValidatable
{
    ...
    /**
     * @var \Tukecx\Base\Core\Services\Validator
     */
    protected $validator;
    ...
    /**
     * @param \Tukecx\Base\Core\Models\EloquentBase $object
     * @param $data
     */
    ...
    {
        if (!$this->validator) {
            $this->validator = new \Tukecx\Base\Core\Services\Validator();
        }
