<?php namespace Tukecx\Base\Core\Http\DataTables;
...
abstract class AbstractDataTables
{
    ...
    protected function view()
    {
        ...
        add_action('footer_js', function () use ($selector, $columns, $ajaxUrl) {
            echo view('tukecx-core::admin._components.datatables.script-renderer', compact(
                'columns', 'selector', 'ajaxUrl'
            ))->render();
        });

        return view('tukecx-core::admin._components.datatables.table', compact(
