...
{
    /**
     * @var \Tukecx\Base\Core\Support\Breadcrumbs
     */
    public $breadcrumbs;

    /**
     * @var \Tukecx\Base\Users\Models\User
     */
    ...
    /**
     * @var \Tukecx\Base\Core\Services\FlashMessages
     */
    ...
    public function __construct()
    {
        ...
        $this->breadcrumbs = \Breadcrumbs::setBreadcrumbClass('breadcrumb')
            ->setContainerTag('ol')
            ->addLink('妖妖竞技', route('admin::dashboard.index.get'), '<i class="icon-home mr5"></i>');
