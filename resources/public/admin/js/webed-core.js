 ...
 * @param options
 */
Tukecx.blockUI = function (options) {
    "use strict";
    options = $.extend(true, {
        animate: false,
        iconOnly: true,
    ...
    if (options.animate) {
        ...
        html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img src="' + Tukecx.settings.adminTheme.getGlobalImagePath() + 'loading-spinner-grey.gif" align=""></div>';
    } else if (options.textOnly) {
        html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
    } else {
        html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img src="' + Tukecx.settings.adminTheme.getGlobalImagePath() + 'loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
    }
 ...
 * @param $target
 */
Tukecx.unblockUI = function ($target) {
    "use strict";
...
Tukecx.ckeditor = function ($elements, config) {
    config = $.extend(true, {
...
Tukecx.handleSelectMediaBox = function () {
    "use strict";
    var $body = $('body');
...
Tukecx.showNotification = function (message, type, options) {
    "use strict";
    options = options || {};
...
Tukecx.slimScroll = function ($element) {
    "use strict";
    if (!$().slimScroll) {
        return null;
    }
...
Tukecx.destroySlimScroll = function ($element) {
    "use strict";
    if (!$().slimScroll) {
        return;
    }
...
Tukecx.stringToSlug = function (text, separator) {
    "use strict";
    separator = separator || '-';
...
Tukecx.tabChangeUrl = function () {
    $('body').on('click', '.tab-change-url a[data-toggle="tab"]', function (event) {
        window.history.pushState('', '', $(this).attr('href'));
    });
};

Tukecx.tagsInput = function ($element, options) {
    "use strict";
    options = $.extend(true, {
...
//# sourceMappingURL=tukecx-core.js.map
